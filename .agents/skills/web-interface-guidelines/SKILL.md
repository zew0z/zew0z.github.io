...
description: Review UI/frontend code for compliance with Vercel's Web Interface Guidelines. Covers accessibility, focus states, forms, animation, typography, performance, touch, dark mode, i18n. Use when auditing or reviewing pages, components, or CSS for quality issues.
---

# Web Interface Guidelines

Read the target files, check against the rules below. Output concise but comprehensive - sacrifice grammar for brevity. High signal-to-noise.
